...
async function main() {
  ...
  await prisma.notification.create({ data: { userId: user.id, type: 'suggestion', title: 'Test usage suggestion', message: 'Disposable review item: used $10 of a dining credit. No usage was written by automation.', metadata: { kind: 'usage' } } })
