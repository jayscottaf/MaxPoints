...
export const perkInput = z.object({
  ...
  periodType: z.enum(['monthly', 'quarterly', 'semi-annual', 'annual', 'one-time', 'anniversary', 'per-booking', 'four-year', 'certificate']),
  valueKind: z.enum(['credit', 'membership', 'coverage', 'estimate', 'information']),
  validUntil: date.optional(), perUseLimit: money.nullable().optional(), requiresConfirmation: z.boolean().optional(),
